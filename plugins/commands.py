    ...
    if len(message.command) != 2:
        if PREMIUM_AND_REFERAL_MODE == True:
            buttons = [[
                ...
                InlineKeyboardButton('💎 Movie Channel 🎥', url=f'https://t.me/+cMEdR31Uc-FmNmQ1'),
                InlineKeyboardButton('🎥 ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ 🍿', url=GRP_LNK)
            ],[
            ...
            buttons = [[
                ...
                InlineKeyboardButton('🎥 ᴇᴀʀɴ ᴍᴏɴᴇʏ 🍿', url=f'https://t.me/+cMEdR31Uc-FmNmQ1'),
                InlineKeyboardButton('🧸 ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ 🧿', url=GRP_LNK)
            ],[
                InlineKeyboardButton('🚦 ʜᴇʟᴘ 🚦', callback_data='help'),
                InlineKeyboardButton('🎀 ᴀʙᴏᴜᴛ 😊', callback_data='about')
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        m=await message.reply_sticker("CAACAgUAAxkBAAJGFGenTln593R0rsap5IY-hyyG56KQAAL3EQAC5Cw4Vb0r0JQgRqwEHgQ") 
    ...
    if data.split("-", 1)[0] == "VJ":
        ...
        if vj and PREMIUM_AND_REFERAL_MODE == True:
            ...
            if CLONE_MODE == True:
                buttons.append([InlineKeyboardButton('ᴄʀᴇᴀᴛᴇ ᴏᴡɴ ᴄʟᴏɴᴇ ʙᴏᴛ', callback_data='clone')])
            reply_markup = InlineKeyboardMarkup(buttons)
            m=await message.reply_sticker("CAACAgUAAxkBAAJGJ2enX92TZmREVQABZ8-aoPhSmLxSGQACRRcAAjy6OVVQ3piHZ_lrux4E") 
            await asyncio.sleep(1)
            await m.delete()
            await message.reply_photo(
            photo=random.choice(PICS),
            caption=f"@Real_Pirates {script.START_TXT.format(message.from_user.mention, temp.U_NAME, temp.B_NAME)}",
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
